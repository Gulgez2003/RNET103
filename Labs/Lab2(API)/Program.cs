...
string apiUrl = $"http://api.openweathermap.org/data/2.5/weather?q={city}&appid=9cbaa6556cba7b68928e7d03f86e0b03";
...
using (HttpClient client = new HttpClient())
{
    try
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            Console.WriteLine($"Temperature in {city}: {temperatureCelsius:F2} °C.");
            Console.WriteLine("Weather forecasts based on the air temperature in your country:");
            Console.WriteLine();
            string result = temperatureCelsius switch
            {
                < 0 => "1. Frosty and cold.\n" +
                       "2. Severe frost.\n" +
